export function Unit3Component() {
    ...
    // Content for Unit 3, Area of Study 2 (full content)
    const aos2Content = `
        <h2>Area of Study 2: Promoting Health in Australia</h2>
        <p class="italic text-slate-400">This area of study examines different approaches to public health over time, focusing on changes and successful strategies that have improved health outcomes. It also investigates initiatives designed to promote health and wellbeing in Australia.</p>
